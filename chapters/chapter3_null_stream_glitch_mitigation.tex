...
The null stream provides us with an extra piece of information in the form of Eq.~\eqref{eq:null-stream-eq}. For the first time, we quantitatively show how this information can be used to address a pressing problem in GW related measurements. Further, in the table \ref{tab:nijntje_conclusion}, we present a comparison between the \ETT~and ET-2L~configuration in the context of glitch mitigation. 
