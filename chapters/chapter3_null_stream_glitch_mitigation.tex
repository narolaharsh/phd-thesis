...
\begin{table}[h!]
 ...
 Glitch mitigation using ET-2L & Glitch mitigation using \ETT \\
    ...
    \begin{enumerate}[leftmargin=*, label=\arabic*.]
        ...
        \item $\mathcal{O}(10)$ hours per analysis. Difficult to scale to meet the demands of 3G-era. Specifically, to analyse the long, loud, and overlapping signals of the 3G-era. \textcolor{white}{Skip this line as well. Skip}
        \item Biases worsen when two interferometers have unequal SNRs, i.e, the signal is in the blind spot of one L but bright spont of another.
    \end{enumerate}
    &
    \begin{enumerate}[leftmargin=*, label=\arabic*.]
        ...
        \item $\mathcal{O}(1)$ hour per analysis. Enables an inexpensive, accurate, and easily scalable framework \texttt{nijntje}. A ready-to-use tool to analyse the long, loud, and overlapping signals using \ETT.
