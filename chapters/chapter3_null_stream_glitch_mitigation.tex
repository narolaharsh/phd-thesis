...
\begin{table}[h!]
 ...
 Glitch mitigation using ET-2L & Glitch mitigation using \ETT \\
    ...
    \begin{enumerate}[leftmargin=*, label=\arabic*.]
        ...
        \item Does not require any prior knowledge of the signal model.
        \item $\mathcal{O}(1)$ hour per analysis. Enables an inexpensive, accurate, and easily scalable framework \texttt{nijntje}. A ready-to-use tool to analyse long, loud, and overlapping signals using \ETT.
