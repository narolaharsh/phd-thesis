...
\begin{figure}
    \centering
    \includegraphics[width=12cm]{../figures/et2l_delta_glitch_overlap_glitch_master.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=12cm]{../figures/newsnr_mismatch_comparison.pdf}
    \caption{Mismatch}
    \label{fig:mismatch}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=12cm]{../figures/newsnr_rank_10_single_block_percentile_parameters_short.pdf}
