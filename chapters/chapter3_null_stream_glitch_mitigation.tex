...
We plan to extend this work by including various kinds of signals and glitches in our analysis. Inspired by the seminal work of Dooney \textit{et al.}~\cite{Dooney:2025bfh}, integration of a deep learning based noise mitigation tool into \texttt{nijntje} framework is already underway. This feature will enable \texttt{nijntje} framework to run on GPUs, leading to a real-time glitch mitigation ($\mathcal{O}(1)$ second per glitch) and overall a sustainable approach for computation. 
