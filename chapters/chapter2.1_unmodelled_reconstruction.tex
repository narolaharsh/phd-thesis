...
Morlet-Gabor wavelets are suitable for the problem at hand because glitches $(\vec{g})$ we want to reconstruct can be expressed as a linear combination of $N$ wavelets~\cite{Cornish:2014kda},
\begin{equation}
