...
\begin{enumerate}
    ...
    \item The rate of convergence in the case of RJMCMC depends on the choice of auxiliary distribution and bijective functions. A universal choice that works for all use cases in GWs is difficult to determine. It has more number of tuning parameters compared to the fixed dimension reconstruction done by Nested sampling. 
    \item The termination criteria are not well defined. \asam{This is more for caution; if you used this algorithm later though, somebody is bound to ask then how did you terminate?}
