...
\begin{figure}
    ...
    \caption{A loud glitch near the merger of the binary neutron star signal GW170817 in LIGO-Livingstone interferometer. Dashed white arrows are added to help reader trace the signal.}
    \label{fig:bns_scan}
\end{figure}
