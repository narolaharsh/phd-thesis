...
\begin{itemize}
\item Glitches occuring near a GW signal could corrupt the physics inferences made from the data. In order to make measurements, it becomes necessary to carefully subtract the glitch without the contaminating the signal, \textit{before} we make physics inferences.
