...
\begin{figure}
    ...
    \caption{\textit{Left:} A GW signal emitted by a BBH merger with a total mass of $176 M_{\odot}$. \textit{Right:} An isolated blip glitch.}
    \label{fig:bbh_blip}
\end{figure} 
