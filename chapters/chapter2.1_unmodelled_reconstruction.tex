...
The progression of the markov chain above does not yet explain \textit{birth} and \textit{death} transitions. In this context, such transition correspond to
\begin{itemize}
    \item Addition of new wavelet
    \item Removal of an existing wavelet
