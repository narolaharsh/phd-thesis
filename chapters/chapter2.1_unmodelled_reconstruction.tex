...
For this scenario, the current state $\vec{\theta}$ has fewer dimensions then the proposed $\vec{\theta'}$. Therefore, we need an auxiliary probability distribution and a mapping function to account for the missing dimensions. These are user-made choices, typically made by trial and error. 
