...
All three GW detectors, LIGO-Livingston, LIGO-Hanford, and LIGO-Virgo were online at the time of arrival of GW170817 and indeed the signal was observed in all three of them. Such multi-detector observation led to precise sky-location and distance measurement of GW170817. It was localised within 28 deg$^2$ area with a 90\% confidence interval and $40^{+8}_{-14}$ Mpc distance, making it the most precisely localized source to date. Such precise localisation allowed the identification of electromagnetic (EM) counterparts, marking this event as the first multimessenger (GW+EM) observation in history. Such a discovery underscores the role of a \textit{network} of GW detectors which may not have been possible with individual detectors. 
