...
All three GW detectors, LIGO-Livingston, LIGO-Hanford, and LIGO-Virgo were online at the time of arrival of GW170817 and indeed the signal was observed in all three detectors. Such multi-detectors observation lead to precise sky-location and distance measurement of GW170817. It was localised within 28 deg$^2$ area with 90\% confidence interval and $40^{+8}_{-14}$ Mpc distance, making it the most precisely localized source to date. Such precise localisation allowed the identification of electromagnetic (EM) counterparts, marking this event as the first multimessenger (GW+EM) observation in the history. Such a discovery underscores the the role of a \textit{network} of GW detectors and which may not have been possible with indivdiual detectors. 
