...
First, I briefly recap the discussion on the gravitational lensing of gravitational waves from chapter \ref{ch:relative_binning}. When GWs encounter a massive object in their path of propagation, they may deviate from their original path. This phenomenon is known as gravitational lensing of gravitational waves. The effect of the lensing on the GW signal can vary depending on the relative configurations of the lens (the massive object), the GW source, and their length scales. 

Specifically, when the length scale of the lens is much larger then the wavelength of the GW siganls, we are in the so-called geometric optics regime. Such scenario can produce multiple copies of the GW signals (known as images) which may be observable by the GW detectors as the repeated copies of the same GW signal. This phenomenon is referred to as the strong lensing of a GW signal. 
