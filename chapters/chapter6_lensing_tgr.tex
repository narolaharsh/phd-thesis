...
In this chapter, we demonstrate how the detection of strongly lensed GW signals can significantly improve upon the general relativistic theories that allow for modified propagation of GWs, specifically modified distance-amplitude relations.  
...
\subsection{Motivation to consider strongly lensed signal over a BNS signal}
...
This paper aims to quantify the gain from GW lensing for 
