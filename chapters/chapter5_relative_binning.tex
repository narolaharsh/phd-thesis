...
\begin{figure}[h]
    ...
    \caption{Analysis of GW190412. The blue colour marks the results obtained from the relative binning method and the grey colour marks the results reported in the GWTC-3 data release.}
    \label{fig:gw190412}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.75\textwidth]{../figures/overlap_production_gw190814_corr_branch_gwtc.pdf}
    \caption{Analysis of GW190814. The blue colour marks the results obtained from the relative binning method and the grey colour marks the results reported in the GWTC-3 data release.}
    \label{fig:gw190814}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{JS divergence plot for all events}
