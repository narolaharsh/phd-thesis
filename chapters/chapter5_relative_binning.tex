...
binning samples and the regular samples for each parameter in Figure~\ref{master-jsd}. Each event is represented by a different coloured marker. 
...
\subsection{Simulated signals for 3G interferometers}
...
\subsection{Strong lensing searches}
