...
Fig.~\ref{fig:speed} shows the speed-up achieved by the relative binning method over the exact method as a function of the total mass of the systems. The colorbar shows the ratio of the length of the uniform frequency grid to the length of the corresponding RBGrid. We denote the ratio by $\Delta$.  
The circles indicate the ratio of total sampling time taken by the exact method compared to the relative binning method. 
