...
\begin{figure}[t]
    ...
    \caption{A truncated corner plot showing the results of parameter estimation performed using relative binning on a GW200220\_061928 
    signal as seen by the ET+CE network of detectors. The black lines show the injected values. 
    The blue contours correspond to $1\sigma$, $2\sigma$, and $3\sigma$ confidence, in order of decreasing opacity.
    }
    \label{fig:third-gen}
\end{figure}
