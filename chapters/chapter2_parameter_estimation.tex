...
While the Bayesian framework described above is conceptually easy, it is still a computationally challenging task to perform the analysis due to the dimensionality of the parameter space of $\vec{\theta}$ (typically 15 to 17), length of the $\vec{d}$, and complexity of simulating of GW signal models. Before diving into optimizing the comutation of the likelihood and exploration of the large parameter space, let us define some standard quantites used in computing the likelihood including the likelihood function itself
