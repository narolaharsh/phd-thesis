...
\begin{figure}
    ...
    \caption{To test the Gaussian-stationary nature, we compare the distribution of 16-seconds of whitened data segment of LIGO-Livingston (blue histogram) with the normal distribution (red outline). The PSD is generated using 2048 seconds of data near the segment.}
...
\end{equation}
which are respectively the first and the second term in the Eq.~\eqref{eq:likelihood}.
