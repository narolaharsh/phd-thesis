...
\begin{itemize}
    \item Stopping criteria is arbitrary
    \item Scales poorly with dimensions and not massively parllelizable
    \item Advantage: Fewer tuning parameters
    \item Sampling over a fixed parameter space
\end{itemize}
