...
\begin{figure}
    ...
    \caption{To test the Gaussian-stationary nature of the data, we compare the distribution of whitened data (blue) with the normal distribution (red). We used 16 seconds of data segment from LIGO-Livingstone detector and the PSD is generated using 2048 seconds of data near the segment.}
\end{figure}
\begin{equation}
    \label{eq:likelihood}
