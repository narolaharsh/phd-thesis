...
%%%sschange bto twoside for printin
%%%aasa%ss%%%\documentclass[a5paper,10pt]{book}
%%% ssssssssssssssssssssss
%\usepasckage[left=1.5cm,right=1.5cm, bottom=1.5cm]{geometry}s
...
\newcommand{\asam}[1]{\textcolor{blue}{[AS: \texttt{#1}}]}

\newcommand{\betaMGR}{\vec{\theta}_\mathrm{MGR}}
...
\def\DEM{D_\mathrm{L}^\textrm{EM}}
\def\DGW{D_\mathrm{L}^\textrm{GW}}
...
\begin{titlepage}
	\begin{center}
		...
		\LARGE\textsc{\textbf{Precision science with Einstein Telescope}}

		\vspace{0.5cm}
		\Large\textsc{Cleaning glitches and accelerating parameter inference for the third generation of gravitational wave detectors}
...
\noindent ISBN: 978-94-6496-537-7 \\
\noindent \textsc{doi}: https://doi.org/10.33540/3429 \\
\noindent Printed by: Gildeprint -- www.gildeprint.nl\\
\noindent Cover design: Harsh Narola \\
...
\begin{titlepage}
	\begin{center}
		...
		\LARGE\textbf{Precision science with Einstein Telescope}
		
		\vspace{0.5cm}
		\Large Cleaning glitches and accelerating parameter inference for the third generation of gravitational wave detectors
	
		\vspace{1.5cm}
		
		\LARGE\textbf{Precisiewetenschap met Einstein Telescoop}
		
		\vspace{0.5cm}
		\Large Het opschonen van storingen en het versnellen van parameterinferentie voor de derde generatie gravitatiegolfdetectoren \\ 
		...
		magnificus, prof. dr. ir. W. Hazeleger, ingevolge het besluit van het college voor promoties in
		het openbaar te verdedigen op donderdag 12 februari 2026 des middags te 4.15 uur
...
\noindent Co-promotor: \\
\indent \indent Dr. A. Samajdar \\

\noindent Assessment Committee: \\
\indent \indent Prof.dr. S.C.M. Bentvelsen \\
\indent \indent Prof.dr. J.F.J. van den Brand \\
\indent \indent Dr. A. Grelli \\
\indent \indent Dr. M. Haney \\
\indent \indent Prof.dr. T. Peitzmann \\
\indent \indent Prof.dr. S.J.G. Vandoren \\
\indent \indent Dr. A. Ghosh \\
...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{From general relativity to gravitational waves}	
\label{ch:gws}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
%%%%%%% New chapter %%%%%%%%%%%%%%%%
\chapter{Measuring the source parameters of gravitational wave signals}
\label{ch:gwpe}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{A framework to utilize the triangular geometry of the Einstein Telescope for precision science}
\label{ch:nijntje3}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
\chapter{A fast parameter estimation method for the current and next generation detectors}
...
\chapter{Constraints on modified propagation theories of GWs using strong lensing}
\label{ch:mod_prop}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
