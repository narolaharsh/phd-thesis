...
\begin{titlepage}
	\begin{center}
		...
		\Huge\textsc{\textbf{Precision science with gravitational wave signals}}
		
		\vspace{0.5cm}
		\Large\textsc{\textbf{Cleaning glitches and acclerating parameter inference for the Einstein Telescope era}}
...
\begin{titlepage}
	\begin{center}
		...
		\LARGE\textbf{Precision science with gravitational wave signals}
		
		\vspace{0.5cm}
		\Large Cleaning glitches and acclerating parameter inference for the Einstein Telescope era
		...
		het openbaar te verdedigen op woensdag 7 februari 2025 des middags te 4.15 uur
