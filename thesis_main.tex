...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{Reconstructing a gravitational wave signals from data and measuring the source properties}
\label{ch:gwpe}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
\chapter{Measuring the parameters of GW source with third-generation telescope}
