...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{To be decided: Deep learning in synergy with null stream based glitch mitigation}
\label{ch:nijntje4}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
\chapter{To be decided: Results of unmodelled search for GW echoes from the fourth observation run of LIGO-Virgo}
\label{ch:echoes}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
