...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{Measuring the parameters of the merging compact binaries from the gravitational wave signal}
\label{ch:gwpe}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
\chapter{Towards the measuring the source parameters of GW signals with third-generation telescope}
