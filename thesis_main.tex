...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{Reconstructing a gravitational wave signals from data and measurements of source properties}
\label{ch:gwpe}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
\chapter{Reconstructing generic excess power from the data}
\label{ch:gwpe}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{Null stream inspired noise transient elimination}
\label{ch:nijntje3}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
...
%%%%%%% New chapter %%%%%%%%%%%%%%%%%
\chapter{Combining deep learning with null stream inspired noise transient elimination}
\label{ch:nijntje4}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[RO]{\slshape\nouppercase{\rightmark}}
